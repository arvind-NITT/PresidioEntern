...
namespace PizzaShopAPI.Service
{
    public class CustomerService : ICustomerService
    {
        private readonly IRepository<int, Customer> _userrepo;
        private readonly IRepository<int, UserCredential> _credentialrepo;

        public CustomerService(IRepository<int, Customer> userRepo, IRepository<int, UserCredential> credentialrepo)
        {
            _userrepo = userRepo;
