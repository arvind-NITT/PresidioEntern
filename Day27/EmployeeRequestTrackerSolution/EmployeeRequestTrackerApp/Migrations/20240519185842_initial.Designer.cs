...
namespace EmployeeRequestTrackerApp.Migrations
{
    ...
    [Migration("20240519185842_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeRequestTrackerApp.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeRequestTrackerApp.Models.Request", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerApp.Models.User", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerApp.Models.Request", b =>
                {
                    b.HasOne("EmployeeRequestTrackerApp.Models.Employee", "RequestClosedByEmployee")
                        .WithMany()
                        .HasForeignKey("RequestClosedBy");

                    b.HasOne("EmployeeRequestTrackerApp.Models.Employee", "RaisedByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeRequestTrackerApp.Models.User", b =>
                {
                    b.HasOne("EmployeeRequestTrackerApp.Models.Employee", "Employee")
                        .WithMany()
